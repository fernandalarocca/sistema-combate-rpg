...
<body>
    <div class="main-layout">
        <section class="header">
            ...
            <button class="open-button" onclick="openForm()"><i class="fa-solid fa-plus"></i> Personagem</button>
            <button class="delete-button"><i class="fa-solid fa-minus"></i> Personagem</button>
